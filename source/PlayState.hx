...
class PlayState extends MusicBeatState
{
	...
	private var angryDad:Bool = false;
	...
	var spookybglights:FlxSprite;
	var screenacid:FlxSprite;
	...
	override public function create()
	{
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + ("Port YT: Matheus Silver"), 16);
	...
	function startCountdown():Void
	{
		...
		startTimer = new FlxTimer().start(Conductor.crochet / 1000, function(tmr:FlxTimer)
		{
			...
			{
				case 0:
					FlxG.sound.play(Paths.sound('intro3' + altSuffix), 1.0);
				case 1:
					...
					FlxG.sound.play(Paths.sound('intro2' + altSuffix), 1.0);
				case 2:
					...
					FlxG.sound.play(Paths.sound('intro1' + altSuffix), 1.0);
				case 3:
					...
					FlxG.sound.play(Paths.sound('introGo' + altSuffix), 1.0);
				case 4:
			}
	...
	*/
	...
	override function stepHit()
	{
		...
		//zoom
			...
			//parte meio 1
				...
				//pitch mudou musicista pra caraio slk
	...
	override function beatHit()
	{
		...
		switch (curStage)
		{
			...
			case "spookyparty":
				spookers.animation.play('bop', true);
