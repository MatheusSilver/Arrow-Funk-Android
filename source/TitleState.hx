...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var bg:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('titlebg1'));
		...
		var bgmenu1:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('titlebg3'));
		// bgmenu1.antialiasing = true;
		// bgmenu1.setGraphicSize(Std.int(bg.width * 0.6));
		// bgmenu1.updateHitbox();
		add(bgmenu1);
		...
		gfDance = new FlxSprite(FlxG.width * 0.8, FlxG.height * 0.14);
	...
	override function update(elapsed:Float)
	{
		...
		{
			FlxTween.tween(FlxG.camera, {x:-2000}, 4.4, {ease: FlxEase.expoInOut});
			FlxTween.tween(gfDance, {y:2000}, 4.4, {ease: FlxEase.expoInOut});
