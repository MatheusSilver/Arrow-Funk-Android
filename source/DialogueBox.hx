...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		//Paths.getSparrowAtlas('dialogueshit/speech_bubble_talking', 'shared');
		//= new FlxSprite(320, 170).loadGraphic(Paths.getSparrowAtlas('dialogueshit/speech_bubble_talking', 'shared'));
